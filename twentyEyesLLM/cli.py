...
from .config import DEFAULT_JOB_INTERVAL, OLLAMA_HOST, VERBOSITY
...
from .errors import OPENAI_ERROR, OLLAMA_ERROR, CLI_HISTORY_PARAM_ERROR, CLI_MODEL_PARAM_ERROR, CLI_REPORT_DATE_ERROR
...
def run(
    ...
    host: Optional[str] = typer.Option(OLLAMA_HOST, "--host"),
