...
OLLAMA_ERROR = "Ollama setup fails. please, check the server or the configuration settings."
FILE_ERROR = "Error on load the image"
DIR_ERROR = "Error on load file"
JSON_ERROR = "Error on parse the json local file"
CLI_MODEL_PARAM_ERROR = "You must choose one LLM to run. Type \"run --help\" to see the running options.\n"
