...
from .config import MAX_TOKENS_INFERENCE, OLLAMA_HOST, OLLAMA_LOCAL_MODEL, OLLAMA_MODEL_FILE_PATH, OPENAI_MODEL
...
def _load_modelfile() -> str:
    ...
    with open(OLLAMA_MODEL_FILE_PATH, "r") as file:
        modelfile = file.read()
...
def init_ollama(host: str) -> None:
    ...
    """
    _ollama_client.create(
        model=OLLAMA_LOCAL_MODEL,
        modelfile=_load_modelfile()
    )
